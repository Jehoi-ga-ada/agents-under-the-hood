...
def apply_discount(price: float, discount_tier: str) -> float:
    """Apply a discount based on the discount tier and return the final price after the discount.
    Available tiers: bronze, silver, gold.

    Args:
        price (float): price that discount is going to be applied
        discount_tier (str): the discount tier
